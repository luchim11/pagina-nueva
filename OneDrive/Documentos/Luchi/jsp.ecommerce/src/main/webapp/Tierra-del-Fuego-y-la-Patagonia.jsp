		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 mr-auto">
					<img src="./imagenes/tierra-del-fuego-patagonia__product.jpg"
						class="card-img-top" alt="...">
				</div>
				<div class="col-md-6">
					<div class="box">
					<h3 class="heading">Paquete "Tierra del Fuego y la Patagonia"</h3>
							...
							<div class="row">
								...
								<div class="col-md-12 form-group">
									<label for="categoria" class="col-form-label"> Plan </label> <select
										...
										<option value="1">5 dias ($2575 c/u)</option>
										<option value="2">10 dias ($3300 c/u)</option>
										<option value="3">15 dias ($3875 c/u)</option>

...
<title>Trekking guiado por el circuito O</title>
</head>
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 mr-auto">
					<img src="./imagenes/o-circuit-torres-del-paine__product.jpg"
						class="card-img-top" alt="...">
				</div>

				<div class="col-md-6">
					<div class="box">
						<h3 class="heading">Paquete "Trekking guiado por el circuito
							O"</h3>
							...
							<div class="row">
								...
								<div class="col-md-12 form-group">
									<label for="categoria" class="col-form-label"> Plan </label> <select
										...
										<option value="1">5 dias ($1960 c/u)</option>
										<option value="2">10 dias ($2375 c/u)</option>
										<option value="3">15 dias ($2904 c/u)</option>
